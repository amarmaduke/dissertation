...
All of this originating from a small type theory that extends the Calculus of Constructions with just three new constructs: erased function spaces, dependent intersections, and untyped equality.
...
This work attempts to refine the system of Cedille by specifically altering the equality type into a new system: $\ced$.
...
This philosophy and design result in a partial success: a notion of proof reduction is strongly normalizing and supports all expected properties (e.g. preservation).
...
Therefore, the full type theory $\ced$ is also a proof theory relative to an oracle deciding this external condition.
