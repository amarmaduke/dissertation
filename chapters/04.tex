...
\begin{proof}
    ...
    \begin{proofcase}
        Have $|\sema{\vartheta(e, a, b; (x : A) \cap B)}| = |\ctheta \cdot \sema{A} \cdot \sema{B}\ \edash \sema{a}\ \edash \sema{b}\ \sema{e}| = |\sema{e}|$.
        By the IH applied to $e\pterm$: $\sema{|e|} = |\sema{e}|$.
        Now $\sema{|\vartheta(e, a, b; (x : A) \cap B)|} = \sema{|e|}$ and the case is concluded.
    \end{proofcase}
